...
pubDate: 'Dec 13 2024'
heroImage: '/blog/start-with-nodejs.jpg'
---
...
**Instalación de una versión específica:**  Si necesitas una versión específica de Node.js, 
puedes usar  `brew install node@<version>`. Por ejemplo, para instalar la versión 21:
